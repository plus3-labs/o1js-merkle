...
class ProvableDeepMerkleSubTree {
    ...
    update(index, value) {
        ...
        let fieldArr = Provable.witness(SideNodes, () => {
            let sideNodes = [];
            let nodeHash = this.root;
            for (let i = 0; i < this.height; i++) {
                const currentValue = this.nodeStore.get(nodeHash.toString());
...
function getUpdatesBySideNodes(sideNodes, keyHashOrKeyField, valueHashOrValueField, height, hasher = PoseidonHasherFunc) {
