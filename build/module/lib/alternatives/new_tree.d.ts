 ...
 */
export declare function newTree<T extends TreeBase>(c: new (...args: any[]) => T, db: Level<string, Buffer>, hasher: Hasher, name: string, depth: number, prefilledSize?: number): Promise<T>;
